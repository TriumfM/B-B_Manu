      ...
      <div class="speisekart__conetent">
        ...
        <div class="speisekart__groups">
          ...
          <div class="speisekart__group">
            ...
            <div class="speisekart__group-elements">
              <div class="speisekart__group-element">
                <p class="speisekart__group-element--name"><strong>Ham & Eggs</strong> 5,50 €</p>
                <p class="speisekart__group-element--info">2 Spiegeleier auf gebratenem Speck und Brot</p>
              </div>
              <div class="speisekart__group-element">
                <p class="speisekart__group-element--name"><strong>Kraftpaket</strong> 6,20 €</p>
                <p class="speisekart__group-element--info">Rührei (3 Eier) mit Schinken, 1 Brötchen, Butter</p>
              </div>
              <div class="speisekart__group-element">
                <p class="speisekart__group-element--name"><strong>Das große Süße</strong> 6,90 €</p>
                <p class="speisekart__group-element--info">2 Brötchen, 1 Croissant, Konfitüre</p>
                <p class="speisekart__group-element--info">Honig, Nuss-Nougatcreme, Butter</p>
              </div>
              <div class="speisekart__group-element">
                <p class="speisekart__group-element--name"><strong>Das große Herzhafte</strong> 8,90 €</p>
                <p class="speisekart__group-element--info">2 Brötchen, 1 Scheibe Brot, Butter</p>
                <p class="speisekart__group-element--info">große Aufschnittplatte gemischt</p>
              </div>
              <div class="speisekart__group-element">
                <p class="speisekart__group-element--name"><strong>Pauschalfrühstück (ideal für Gruppen)</strong> 9,90 €</p>
                <p class="speisekart__group-element--info">2 Brötchen, 1 Scheibe Brot, Butter, Konfitüre</p>
                <p class="speisekart__group-element--info">Aufschittplatte gemischt, Portion Rührei, Glas Orangensaft</p>
              </div>
            </div>
            <div class="speisekart__group-photo-info">
          ...
          <div class="speisekart__group">
            ...
            <div class="speisekart__group-elements">
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Brötchen</strong> 0,80€</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Croissant</strong> 2,20€</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Frühstücksei</strong> 1,40€</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Rührei, Spiegelei (2 Eier)</strong> 2,80€</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
              ...
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Portion Lachs</strong> 4,50 €</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Portion gebratener Bacon-Speck</strong> 2,50 €</p>
              </div>
            </div>
            <div class="speisekart__group-photo-info">
          ...
          <div class="speisekart__group">
            ...
            <div class="speisekart__group-elements">
              <div class="speisekart__group-element">
                <p class="speisekart__group-element--name"><strong>Bergisches Krüstchen</strong> 12,90 €</p>
                <p class="speisekart__group-element--info">2 Spiegeleier und Salat</p>
              </div>
              <div class="speisekart__group-element">
          ...
          <div class="speisekart__group">
            ...
            <div class="speisekart__group-elements">
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Tasse Cerro Verde Kaffee 1)</strong> 2,50€</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Pott Cerro Verde Kaffee 1)</strong> 3,50 €</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Kännchen Cerro Verde Kaffee 1)</strong> 4,90 €</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Tasse entkoffeinierter Kaffee</strong> 2,50 €</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Pott entkoffeinierter Kaffee</strong> 3,50 €</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Kännchen entkoffeinierter Kaffee</strong> 4,90 €</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Tasse Cerro Verde Espresso 1)</strong> 2,50 €</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Tasse Cappuccino 1)</strong> 3,20/3,40 €</p>
                <p class="speisekart__group-element--info">mit Milchschaum/mit Sahne</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Latte Macchiato 1)</strong> 3,40 €</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Milchkaffee 1)</strong> 3,40 €</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Pott Halb und Halb </strong> 3,60 €</p>
                <p class="speisekart__group-element--info">(Cerro Verde Kaffee & Azuco Trinkschokolade Vollmilch)</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Tasse Azuco Trinkschokolade Vollmilch</strong> 2,50 €</p>
                <p class="speisekart__group-element--info">mit Sahne</p>
              </div>
              <div class="speisekart__group-element margin_v-10px">
                <p class="speisekart__group-element--name"><strong>Pott Azuco Trinkschokolade Vollmilch</strong> 3,50 €</p>
                <p class="speisekart__group-element--info">mit Sahne</p>
              </div>
            </div>
            <div class="speisekart__group-photo-info">
              <img src="@/assets/img/photo8.png"/>
            </div>
          </div>
          <div class="speisekart__group">
            <div class="speisekart__group-title">
